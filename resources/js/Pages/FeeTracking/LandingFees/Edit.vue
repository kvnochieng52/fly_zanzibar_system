  ...
  <DashboardLayout>
    ...
    <div class="page-title-wrapper">
      <div class="page-title-heading">
        ...
        <div>
          Edit Landing Fee
          <div class="page-title-subheading">Update landing fee record for {{ landingFee.flight_number }}</div>
        </div>
      </div>
      <div class="page-title-actions">
        <Link :href="route('landing-fees.show', landingFee.id)" class="mb-2 mr-2 btn btn-info">
          ...
          <div class="row mt-4">
            <div class="col-md-12">
              <div class="d-flex justify-content-between">
                <div>
                  <Link :href="route('landing-fees.show', landingFee.id)" class="btn btn-info mr-2">
                    <i class="fa fa-eye"></i> View Details
                  </Link>
                ...
                <button type="submit" class="btn btn-primary" :disabled="processing">
                  ...
                  <span v-else>Update Landing Fee</span>
                </button>
              </div>
            </div>
          </div>
...
export default {
  ...
  setup(props) {
    const form = useForm({
      flight_number: props.landingFee.flight_number,
      flight_date: props.landingFee.flight_date,
      aircraft_id: props.landingFee.aircraft_id,
      airport_id: props.landingFee.airport_id,
      mtow_used: props.landingFee.mtow_used,
      fee_amount: props.landingFee.fee_amount,
      currency_id: props.landingFee.currency_id,
      payment_status_id: props.landingFee.payment_status_id,
      payment_date: props.landingFee.payment_date,
      receipt_reference: props.landingFee.receipt_reference,
      invoice_reference: props.landingFee.invoice_reference,
      authority_document: props.landingFee.authority_document,
      notes: props.landingFee.notes,
      is_calculated_auto: props.landingFee.is_calculated_auto ?? true,
      manual_override_amount: props.landingFee.manual_override_amount,
      override_reason: props.landingFee.override_reason
    })
  ...
  methods: {
    submit() {
      this.form.put(route('landing-fees.update', this.landingFee.id), {
        onSuccess: () => {
