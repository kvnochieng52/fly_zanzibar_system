  ...
  <DashboardLayout>
    ...
    <div class="page-title-wrapper">
      <div class="page-title-heading">
        ...
        <div>
          Edit Role: {{ role.name }}
          <div class="page-title-subheading">Modify role permissions and details</div>
        </div>
      </div>
            ...
            <div class="col-md-12">
              <div class="mb-3">
                ...
                <span class="ml-3 text-muted">
                  <strong>{{ form.permissions.length }}</strong> of {{ permissions.length }} permissions selected
                </span>
              </div>
