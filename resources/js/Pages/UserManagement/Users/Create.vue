  ...
  <DashboardLayout>
    ...
    <div class="page-title-wrapper">
      <div class="page-title-heading">
        <div class="page-title-icon">
          <i class="fa fa-user-plus icon-gradient bg-success"></i>
        </div>
        <div>
          Create New User
          <div class="page-title-subheading">Add a new user to the system and assign roles</div>
        </div>
      </div>
    ...
    <div class="main-card mb-3 card">
      <div class="card-header">
        <i class="header-icon fa fa-user-plus icon-gradient bg-success"></i>
        User Details
      </div>
          ...
          <div v-else class="row">
            <div class="col-md-12">
              <div class="alert alert-info">
                ...
                <Link :href="route('roles.create')" class="btn btn-sm btn-primary ml-2">
                  Create Role
                </Link>
              </div>
            </div>
